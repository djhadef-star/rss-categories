...
CATEGORIES = {
    "1. SMARTPHONE": [
        ...
        "s25", "s26", "s27", "s28", "galaxy s", "oppo", "pliant", "pliable"
    ],
    "2. PC": [
        ...
        "galaxy book", "carte mère", "cartes mères", "gpu", "arm", "laptop"
    ],
    "3. Periphérique": [
    ...
    "8. Audio": [
        ...
        "égaliseur", "musique", "voix"  # Le mot parasite "son" a été retiré
    ],
    "9. Moiilité douce": [
        "mobilité", "vélo", "trottinette", "cargo", "sacoche", "antivol", "vae",
        "navigo", "blablacar", "taxi", "rer", "transport en commun", "ebike",
        "vtt", "segway", "veste", "avion", "aéroport", "gps", "pompe", "compteur vélo"
    ],
    "10. Voiture": [
    ...
    "15. ludique": [
        ...
        "disney+", "disney", "game boy", "lego", "hbo max", "apple tv",
        "paramount", "saison", "chef d'oeuvre", "roman", "dessin", "dessine",
        "bande-dessinée", "manga", "teaser"
    ],
    "16. actu jur et pol": [
        ...
        "ministère", "usurpation", "guerre", "impôts", "fisc", "hacker", "conforme"
    ],
    "17. Actualité éco": [
    ...
    "18. Sciences": [
        ...
        "nucléaire", "astéroïde", "cratère", "iss", "l'iss", "spacex", "lunaire",
        "implant", "cerveau"
    ],
    "19. Sponso": [
...
def categorize_article(title, url=""):
    ...
    for category, keywords in CATEGORIES.items():
        # Pour la catégorie 19 (Sponso), recherche dans Titre + URL
        # Pour toutes les autres catégories, recherche UNIQUEMENT dans le Titre
        ...
        for keyword in keywords:
            ...
            # \b garantit la correspondance exacte au début de mot
            ...
            if match:
                ...
                # Sélectionne le mot-clé le plus haut placé dans le titre
...
def main():
    ...
    # 1. RÉÉVALUATION SYSTÉMATIQUE DE L'HISTORIQUE EXISTANT
    ...
    # 3. Scraping spécifique Web Frandroid
    frandroid_sections = [
    ...
    print("Fichier CSV entièrement nettoyé et réévalué !")

    # 5. Actualisation de l'Excel multi-onglets
