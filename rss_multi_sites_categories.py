...
# ============================================================
# 2. Définition des Mots-Clés et Catégories
# ============================================================

CATEGORIES = {
    "SMARTPHONE": [
        "smartphone", "phone", "pixel", "forfait", "android", "ios", "5g", "6g", "réseau", "esim", "wifi", 
        "routeur", "netgear", "ethernet", "traceur", "tag", "lunette", "appli", "application"
    ],
    "PC": [
    ...
    "PERIPHERIQUE": [
        "clavier", "écran", "souris", "imprimante", "logitech", "corsair", "steam deck", "chargeur", 
        "charge", "batterie externe", "ugreen", "branche", "lexar", "périphérique", "hub", "dock"
    ],
    "TABLETTE": [
        "tablette", "fold", "pad", "kindle", "remarkable", "liseuse", "kobo", "ebook", "pliable", 
        "pliure", "pli"
    ],
    "LOGICIELS_OS": [
        "logiciel", "sofware", "windows", "macos", "office", "linux", "bios", "os", "mail", "rss", 
        "slack", "teams", "capture", "outlook", "onenote", "gmail", "drive", "cleaner", "vpn", 
        "traduction", "chat", "automatisation", "edge", "chrome", "safari", "firefox", "opera", 
        "vivaldi", "github", "power toys", "moteur de recherche"
    ],
    "IA": [
        "ia", "ai", "token", "anthropic", "gemini", "meta", "claude", "openclaw", "perplexity", 
        "prompt", "copilot", "siri", "deepseek", "mistral", "groq", "midjourney", 
        "intelligence artificielle", "open ai", "chat gpt"
    ],
    "VIDEO": [
    ...
    "AUDIO": [
        "casque", "audio", "pod", "bud", "headphone", "jbl", "shockz", "clip", "écouteur", "enceinte", 
        "barre de son", "harman", "sennheiser", "bose", "sonos", "réduction de bruit"
    ],
    "MOBILITE_DOUCE": [
        "mobilité", "vélo", "trottinette", "cargo", "sacoche", "antivol", "vae", "navigo", "blablacar", 
        "taxi", "rer", "ebike", "vtt", "segway", "transport en commun"
    ],
    "VOITURE": [
        ...
        "jeep", "twingo", "autonome", "fsd", "waze", "auto", "carplay", "taxe", "moto", "scooter", 
        "hybride", "électrique", "borne", "google maps"
    ],
    "MENAGE": [
        "aspirateur", "dyson", "roborock", "narwal", "mova", "ecovacs", "dreame", "tineco", "shark", 
        "laveur", "lavage", "vitre", "pressing", "défroisseur", "tambour", "maison", "linge", 
        "vaisselle", "robot aspirateur", "machine à laver", "centrale vapeur", "fer à repasser", 
        "lave-vaisselle"
    ],
    "CUISINE": [
        ...
        "soda", "agrume", "frigo", "réfrigérateur", "congélateur", "plante", "jardin"
    ],
    "MAISON": [
    ...
    "SANTE": [
        "santé", "fitbit", "bracelet", "circa", "montre", "watch", "sommeil", "dormir", "onde", 
    ...
    "LUDIQUE": [
        "jeu", "ludique", "enfant", "cinéma", "film", "switch", "playstation", "xbox", "manette", 
        "vr", "nefflix", "canal", "tf1", "série", "ps5", "ps4", "nintendo", "steam", "gaming", 
        "jeux de société", "jeux vidéo"
    ],
    "ACTU_JUR_POL": [
        "ue", "cnil", "souveraineté", "europe", "chine", "russie", "iran", "condamnée", "condamné", 
        "condamne", "gafam", "arcom", "rgpd", "bruxelles", "otan", "procès", "plainte", "règle", 
        "réglementaton", "loi", "juge", "justice", "tribunal", "sanction", "dsa", "politique", 
        "onu", "etat", "trump", "géopolitique", "diplomatie", "cyberattaque", "piratage", "taxe", 
        "présidentielle", "amende", "décret", "législation", "conseil d'état", "ia act", 
        "union européenne", "la france", "comission européenne"
    ],
    "ACTU_ECO": [
        "dépense", "bourse", "milliard", "rachat", "capitalisation", "acquisition", "argent", 
        "opa", "fusion", "bulle", "usine", "production", "productivité", "salaire", "salarié", 
        "grève", "énergie", "énergétique", "rente", "rentable", "perte", "bénéfice", "comptable", 
        "crise", "pénurie", "inflation", "chômage", "licenciement", "chiffre d'affaires", 
    ...
    try:
        ...
        for _, row in df_old.iterrows():
            ...
            if not cat or cat == "nan" or cat == "NON_CLASSE":
                ...
                # Permet de mettre à jour une catégorie existante si les nouveaux mots-clés correspondent mieux
